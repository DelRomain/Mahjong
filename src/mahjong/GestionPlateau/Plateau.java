...
import mahjong.TypeDeCoup.Coup;
import mahjong.TypeDeCoup.CoupMelangerPlateau;
...
public class Plateau {
    ...
    public Tuile getTuile(int indexLigne, int indexColonne) {
        Tuile tuile = null;
        if ((0 <= indexLigne && indexLigne < Plateau.NOMBRE_COLONNE)
                && (0 <= indexColonne && indexColonne < Plateau.NOMBRE_LIGNE)) {
