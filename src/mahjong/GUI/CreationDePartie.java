...
/**
 * Fenetre permettant de créer ou charger une partie
 */
public class CreationDePartie extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public CreationDePartie(Fenetre parent, boolean modal) {
        super(parent, modal);
